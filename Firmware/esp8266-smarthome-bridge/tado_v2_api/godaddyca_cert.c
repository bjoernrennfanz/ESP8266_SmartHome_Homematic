 ...
 *  my.tado.com in PEM format, as dumped via:
 *
 *  openssl s_client -showcerts -connect my.tado.com:443 </dev/null
 *
...
/*
 * 3 s:/C=US/O=The Go Daddy Group, Inc./OU=Go Daddy Class 2 Certification Authorit                                                   y
 * i :/C=US/O=The Go Daddy Group, Inc./OU=Go Daddy Class 2 Certification Authorit
 */
const char *godaddy_root_ca_cert = "-----BEGIN CERTIFICATE-----\r\n"
